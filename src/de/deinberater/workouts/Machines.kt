    ...
    companion object {
        ...
        fun getMoreInfoByName(machineName: String): Map<String, Any> {
            val machines = buildMap {
                ...
                put("Shrugs Trap Bar", mapOf("type" to MachineType.DefaultMachine, "baseWeight" to 20.0))
                ...
                put("Shrugs", mapOf("type" to MachineType.PlateMachine, "baseWeight" to 0.0))
                put("Beinpresse", mapOf("type" to MachineType.PlateMachine, "baseWeight" to 0.0))
                ...
                put("Bizeps Curl Stange", mapOf("type" to MachineType.Bar, "baseWeight" to 10.0))
